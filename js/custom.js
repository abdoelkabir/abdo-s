...
//         // let first_slide = document.getElementsByClassName('slide')[0];
//         // first_slide[0].classList.add('active');
//     }
// }
...
//     h2.innerText = counter+'  -  appended h2 from js'
...
add_task_btn.addEventListener('click',function(){
    ...
    // list_item.innerText = task_text;
    let list = document.querySelector('.to-do-list')
    list.appendChild(list_item);
    task_input.value = '';
});

// document.querySelector('#task-1').addEventListener('click',function(){
//     this.remove();
//     document.querySelector('#task-1').remove();
// })
